namespace WinUX.UWP.Samples.Samples.Controls.ValidatingTextBox
{
    using Windows.UI.Xaml;
    using Windows.UI.Xaml.Navigation;

    public sealed partial class ValidatingTextBoxSamplePage
    {
        public ValidatingTextBoxSamplePage()
        {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            {
                AppShell.Instance.ViewModel.Title = "ValidatingTextBox sample";
            }
